            ...
            <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-3">
                        <div
                            className={`w-10 h-10 bg-gradient-to-br ${gradient} rounded-full flex items-center justify-center shadow-md flex-shrink-0`}
                        >
                            <Heart className="h-5 w-5 text-white" />
                        </div>
                        <div>
                            <h3 className="font-bold text-white text-base sm:text-lg">{tribute.full_name}</h3>
                            <p className="text-xs sm:text-sm text-gray-300 font-medium">
                                {formatDate(new Date(tribute.created_at).getTime())}
                            </p>
                        </div>
                    </div>
                ...
                <p className="text-gray-200 leading-relaxed text-sm sm:text-base">{tribute.tribute}</p>
            </CardContent>
        </Card>
    );
}
